...
class RewardFunction(Generic[AgentID, StateType, RewardType]):
    ...
    @abstractmethod
    def get_rewards(self, state: StateType, is_terminated: Dict[AgentID, bool], is_truncated: Dict[AgentID, bool], shared_info: Dict[str, Any]) -> Dict[AgentID, RewardType]:
        #TODO update docs
        """
        ...
        :return: A dict of rewards, one for each player in GameState.
        """
        raise NotImplementedError
